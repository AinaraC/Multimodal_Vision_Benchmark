...
val_evaluator = dict(
    type='KittiMetric', ann_file=data_root +'kitti_infos_val.pkl', corruption_savepath='data/kittiCorrupt', corruption_eval=True, model_name='bevfusion')
